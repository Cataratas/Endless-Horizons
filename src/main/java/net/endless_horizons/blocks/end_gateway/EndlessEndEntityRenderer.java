...
public class EndlessEndEntityRenderer implements BlockEntityRenderer<EndlessEndEntity> {
    ...
    private void renderSides(Matrix4f matrix, VertexConsumer vertexConsumer) {
        ...
        this.renderSide(matrix, vertexConsumer, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, 1.0F);
        this.renderSide(matrix, vertexConsumer, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F);
    }
